        ...
        <div class="carousel-item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-light" href="{{route('getCollection', ['category' => 'assassins-creed'])}}">Ver colección</a></p>
            </div>
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="carousel-caption text-right">
              ...
              <p><a class="btn btn-lg btn-light" href="{{route('getCollection', ['category' => 'final-fantasy'])}}">Ver productos</a></p>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="carousel-caption text-right">
              ...
              <p><a class="btn btn-lg btn-light" href="{{route('getCollection', ['category' => 'gaming'])}}">Ver productos</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="album bg-white">
      <div class="container">
        ...
        <div class="row">
          ...
          <!--@if(strpos($product->product_name, 'a') !== false)-->
