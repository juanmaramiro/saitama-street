                  ...
                  @foreach($carts as $cart)
                    ...
                    @if($cart->cart_user_id == Auth::user()->id)
                      ...
                      @endforeach
                        ...
                        <td class="text-right">
                          <button title="Actualizar cantidad" type="submit" class="btn btn-light mr-2" form="update-quantity-{{$cart->id}}"><i class="fas fa-sync-alt"></i></button> 
          ...
          <aside class="col-md-3">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <!-- Hidden form -->
                <form id="checkout" name="checkout" action="{{ route('checkout') }}" method="POST" style="display: none;">
                  {{ csrf_field() }}
