                  ...
                  <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($cart->cart_user_id == Auth::user()->id): ?>
                      ...
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td class="text-right">
                          <a href="<?php echo e(url('carrito/update')); ?>" title="Actualizar cantidad" class="btn btn-light mr-2"><i class="fas fa-sync-alt" onclick="event.preventDefault(); document.getElementById('update-quantity-<?php echo e($cart->id); ?>').submit();"></i></a> 
            ...
            <div class="card">
              <div class="card-body">
                ...
                <dl class="dlist-align">
                  ...
                  <dd class="text-right">-<?php echo e($descuento); ?>€</dd>
                </dl>
                <dl class="dlist-align">
                  <dt>Total:</dt>
                  <dd class="text-right h5"><strong><?php echo e($total - $descuento); ?>€</strong></dd>
                </dl>
                <hr>
