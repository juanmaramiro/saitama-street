            ...
            <aside class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <img src="../../../storage/users_avatar/<?php echo e(Auth::user()->avatar); ?>" alt="<?php echo e(Auth::user()->name); ?>" style="border-radius: 10px" class="img-fluid" max-width="100%" height= "auto"/><br><br>
