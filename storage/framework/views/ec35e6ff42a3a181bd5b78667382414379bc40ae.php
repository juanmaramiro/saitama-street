...
<?php $__env->startSection('content'); ?>
	...
	<div class="container">
  		<div class="py-5 text-center">
    		...
    		<p class="lead">Ya queda menos para realizar tu pedido, <?php echo e(Auth::user()->name); ?>, ¡solo te falta rellenar estos campos!</p>
  		</div>
  		...
  		<div class="row">
    		<div class="col-md-4 order-md-2 mb-4">
	      		<h4 class="d-flex justify-content-between align-items-center mb-3">
			        ...
			        <span class="badge badge-secondary badge-pill"><?php echo e($cartItems); ?></span>
			    </h4>
			    <div class="card mb-3" style="border: 0">
			                ...
			                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			                    ...
			                    <?php if($product->id == $cart->cart_product_id): ?>
			        				...
			        				<div class="list-group-item d-flex justify-content-between">
			          					<div>
			            					<h6 class="my-0"><?php echo e($product->product_name); ?></h6>
			            
			            					<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

			                                	<?php if($category->id == $product->category_id): ?>

			            							<small class="text-muted"><?php echo e($category->category_name); ?></small>
			          					...
			          					<span class="text-muted"><?php echo e($product->product_price); ?><small>€</small> x<?php echo e($cart->product_quantity); ?></span>
			        				</div>
			        ...
			        <div class="list-group-item d-flex justify-content-between bg-light">
			          ...
			          <span class="text-success">-<?php echo e($discount); ?>€</span>
			        </div>
			        <div class="list-group-item d-flex justify-content-between">
			          <span>Total</span>
			          <strong><?php echo e($total); ?><small><b>€</b></small></strong>
	        		</div>
	      		</div>
    		</div>
		    <div class="col-md-8 order-md-1">
		      <h4 class="mb-3 text-muted">Dirección de envío</h4>
		      <form class="needs-validation" action="<?php echo e(route('endCart')); ?>">
		        <div class="row">
		        ...
		        <div class="mb-3">
		          ...
		          <div class="input-group">
		            ...
		            <input type="text" class="form-control" id="username" value="<?php echo e(Auth::user()->name); ?>" readonly>
		          </div>
		        </div>
